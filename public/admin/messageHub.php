...
<section class="section contact" data-admin-id="<?php echo htmlspecialchars($adminId); ?>">
  ...
  <div class="row">
    <div class="col-12">
      <div class="messaging-engine-header">
        <h5 class="card-title">Real-time Messaging</h5>
        <p class="messaging-subtitle">Instant communication between registered users and co-admins.</p>
      </div>
              ...
              <div class="admin-conversations-panel">
                <div class="panel-search-wrapper">
                  ...
                  <div class="search-input-group">
                    ...
                    <input type="text" id="adminConversationSearch" placeholder="Search users...">
