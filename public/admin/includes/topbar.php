...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <nav class="header-nav ms-auto">
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link nav-icon" href="Contacts" data-bs-toggle="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
          <li class="dropdown-header" id="global-message-header">
            Support Chat Center
            <a href="Contacts"><span class="badge rounded-pill bg-success p-2 ms-2">Open Chat</span></a>
          </li>
          <li><hr class="dropdown-divider"></li>
          ...
          <li><hr class="dropdown-divider"></li>
          <li class="dropdown-footer"><a href="Contacts">Go to Support Inbox</a></li>
        </ul>
      </li>
